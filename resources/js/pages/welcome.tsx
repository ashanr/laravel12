                    ...
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            <Link
                                ...
                                className="inline-block rounded-md border border-[#19140035] px-5 py-2 text-sm font-medium leading-normal text-[#1b1b18] bg-white shadow-sm hover:bg-[#f5f5f5] hover:border-[#1915014a] transition-colors dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:bg-[#161615] dark:hover:border-[#62605b] dark:hover:bg-[#232320]"
                            >
                                Dashboard
                            </Link>
                        ) : (
                            <>
                                <Link
                                    href={route('login')}
                                    className="inline-block rounded-md border border-transparent px-5 py-2 text-sm font-medium leading-normal text-[#1b1b18] bg-white shadow-sm hover:bg-[#f5f5f5] hover:border-[#19140035] transition-colors dark:text-[#EDEDEC] dark:bg-[#161615] dark:hover:border-[#3E3E3A] dark:hover:bg-[#232320]"
                                >
                                    Log in
                                </Link>
                                <Link
